...
export const performanceStats = [
  { label: "Power", value: 235, suffix: " PS", icon: Gauge },
  { label: "Torque", value: 367, suffix: " Nm", icon: Car },
  { label: "Turbo Engine", value: 1, suffix: "", custom: "Turbo", icon: Zap },
  { label: "Hybrid Technology", value: 1, suffix: "", custom: "Hybrid", icon: BatteryCharging }
];
