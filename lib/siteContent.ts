...
export const defaultContent: EditableContent = {
  ...
  cta: {
    ...
    body: "Connect with Adnan for availability, vehicle consultation, and a private OMODA JAECOO test drive appointment.",
    button: "Contact Adnan",
    whatsapp: "https://wa.me/6282288855564"
  },
  gallery: [
