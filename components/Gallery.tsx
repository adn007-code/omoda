    ...
    <section id="gallery" className="py-10 sm:py-16">
      <div className="container-lux">
        <div className="mb-12 max-w-3xl">
          <p className="mb-4 text-xs font-bold uppercase tracking-[0.42em] text-[#c9a75d]">Galeri</p>
        ...
        <div className="masonry">
          {content.gallery.map((src, index) => (
            <button
              ...
              aria-label="Buka gambar galeri"
            >
              <EditableImage
                src={src}
                alt={`Gambar galeri JAECOO J5 ${index + 1}`}
        ...
        {selected ? (
          ...
          >
            <button
              ...
              aria-label="Tutup pratinjau galeri"
              onClick={() => setSelected(null)}
            >
              <X className="h-5 w-5" />
            </button>
            ...
            >
              <EditableImage
                src={selected}
                alt="Pratinjau galeri JAECOO J5 yang diperbesar"
                sizes="100vw"
