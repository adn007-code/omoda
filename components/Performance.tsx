    ...
    <section id="performance" ref={sectionRef} className="relative overflow-hidden py-24 sm:py-32">
      ...
      <div className="container-lux relative z-10">
        <div className="max-w-3xl">
          <p className="mb-4 text-xs font-bold uppercase tracking-[0.42em] text-[#c9a75d]">Performance</p>
          ...
          <p className="mt-6 text-lg leading-8 text-white/64">
            Strength, response, and efficiency come together in a luxury SUV tuned for urban momentum and confident
            weekend distance.
          </p>
        </div>
